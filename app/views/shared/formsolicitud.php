<form action="<?php echo RUTA_URL ?>/HomeController/enviarSolicitud" method="POST" id="form1" name="form1">
    ...
    <div class="row form-group">
        <div class="col-md-12">
            ...
            <input name="nombre" type="text" id="fullname" class="form-control">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-md-12">
            <label for="mail">Correo Electronico</label>
            <input name="mail" type="mail" id="mail" class="form-control">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-md-12">
    ...
    <div class="row form-group">
        <div class="col-md-12">
            ...
            <input type="text" pattern="[0-9]{14,15}" maxlength="15" onkeypress="return isNumberKey(event, this.value)" 
            id="imei" name='imeitext' placeholder="Ingresa los 14 o 15 dígitos del IMEI" class="form-control">
        </div>
    </div>
    
    <div class="row form-group">
        <div class="col-md-12">
            <input type="submit" onclick="validar(document.form1.imeitext)" class="btn btn-primary btn-block" value="Submit">
        </div>
    </div>
</form>	